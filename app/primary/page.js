      ...
      <section className="mt-10">
        <div className="w-4/5 mx-auto shadow-lg bg-slate-50">
          <h2 className="py-4 text-3xl font-bold text-center border-b-2">
            Syllabus of Nursery to Class 5
          </h2>

          <div class="relative overflow-x-auto rounded-lg p-10">
            <table class="w-4/5 mx-auto text-sm text-black text-center shadow-lg">
              ...
              <tbody>
                <tr class="border-b-2">
                  ...
                  <td class="px-6 py-4">
                    <Link href="https://drive.google.com/drive/folders/15j8R9J9wHPdhZzKry7TYpMSQhrso_dkQ"><button type="submit" className="hover:text-teal-400 duration-300">Download</button></Link>
                  </td>
                </tr>
                <tr class="border-b-2">
                  <th
